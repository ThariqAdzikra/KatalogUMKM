document.addEventListener('DOMContentLoaded', function () {
    ...
    document.addEventListener('submit', function (e) {
        ...
        if (target.matches('form.delete-form')) {
            ...
            const msg = target.getAttribute('data-confirm-message') || 'Apakah Anda yakin ingin menghapus data pelanggan ini?';
    ...
    if (confirmBtn) {
        confirmBtn.addEventListener('click', function () {
            if (formToSubmit) {
                ...
                // Ini akan merefresh halaman dan menjalankan logic di controller
                formToSubmit.submit();
